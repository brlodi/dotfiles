function base16_set_theme -d "Set terminal colors with base16-shell"
  set -l theme $argv
  ...
  if status --is-interactive; and test -e {$base16_theme_script}
    ...
    echo -e "colorscheme base16-$theme\nlet g:airline_theme='base16_shell'" > ~/.vim_colors
  else
